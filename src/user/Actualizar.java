 ...
 * @author regil
 */
public class Actualizar implements registro {
  ...
  Connection con = db.getconexion();
    ...
    String sql="UPDATE user SET user_name = ?, password = ?,  Nombre = ?, Apellido = ?, Email = ?, Telefono = ? WHERE id_user = ?";
    try{
    ...
    ps.setString(7,usr.getId().toString());
    ps.execute();
    return true;
